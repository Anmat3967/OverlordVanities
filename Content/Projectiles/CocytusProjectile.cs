...
{
    public class CocytusProjectile : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (player.dead || !player.HasBuff(ModContent.BuffType<CocytusBuff>()))
            {
                Projectile.Kill();
            ...
            int extraX = player.direction * (player.HasBuff(BuffID.StardustGuardianMinion) ? -80 : -40);
            float bobY = (float)Math.Sin(Main.timeForVisualEffects / 20 + Math.PI) * 4f;
