...
using OverlordVanities.Content.Items.Placeable;
...
{
	public class ShallChair : ModTile
	{
		...
		public override void SetStaticDefaults()
		{
			...
			DustType = ModContent.DustType<PeroDust>();
			AdjTiles = new int[] { TileID.Thrones };

			// Names
			AddMapEntry(new Color(77, 32, 74), Language.GetText("MapObject.Chair"));
		...
		{
			Item.NewItem(new EntitySource_TileBreak(i, j), i * 16, j * 16, 16, 32, ModContent.ItemType<Items.Placeable.ShallChair>());
		}
		...
		public override void MouseOver(int i, int j)
		{
			...
			player.cursorItemIconID = ModContent.ItemType<Items.Placeable.ShallChair>();
